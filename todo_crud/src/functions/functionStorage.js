...
export const handleOnChange = ({target: {value}}, setBoardText, setInput) => {
  setBoardText(value);
  setInput(value);
};
...
export const displayControlBoard = (setBtnMenu, setBtnAdd, setBtnDel,setBoardrBtnMenu, setBoardBtnAdd, setBoardBtnDelete) => {
...
//popup menu control
export const handleBoardOpenCloseBtn = (set1, set2, set3, boardBtnAdd, set4, set5, set6, setBoardBtnMenuLight, bulbSet1, bulbSet2) => {
